...
void gdt_set_entry(int index, uint32_t base, uint32_t limit, uint8_t access, uint8_t gran) {
    ...
    /* Low 16 bits and high 4 bits of limit, since the high 4 bits of limits is between granularity
    and access, and we don't have 4 bit variable,
...
void gdt_init() {
    ...
    */
    ...
    /* Kernel data, access(92 = 1 00 1 0 0 1 0)
        Only differ at the fifth bit(counting from least insignificant bit), 0 means it's a data
       segment.
    */
